...
const __chunk_1 = require('./chunk-9cecc651.js');
...
class MyComponent {
    constructor(hostRef) {
        ...
        this.changeOrgCard = __chunk_1.createEvent(this, "changeOrgCard", 7);
        this.changeRefCard = __chunk_1.createEvent(this, "changeRefCard", 7);
        this.changeSgrnaCard = __chunk_1.createEvent(this, "changeSgrnaCard", 7);
        this.sgDataSection = __chunk_1.createEvent(this, "sgDataSection", 7);
    }
    // *************************** CLICK ***************************
    ...
    generateGenomicCard() {
        ...
        let div = select(this.element.shadowRoot.querySelector(".genomeGraph"))
            .append('div')
    ...
    // *************************** SUNBURST **************************
    generatePlot() {
        const treeClustering = new TreeClustering(this.sizeSelected, this.show_data, 4, 7);
        ...
        const root = partition().size([2 * Math.PI, radius])(hierarchy(treeClustering.root).sum((d) => d['niv']));
        ...
        const color = quantize()
            .domain([0, maxChild])
            // @ts-ignore
            .range(['#F7FACE', '#E0F6BF', '#C1F2B0', '#A3EDAA', '#96E7B9', '#8BE0CD', '#80CDD8', '#6DA7C3', '#5B81AD', '#4A5E95', '#3A3E7D']);
        const svg = select(this.element.shadowRoot.querySelector('#displayGenomicCard'));
    ...
    render() {
        ...
        if (this.all_data == undefined) {
            return ([
                __chunk_1.h("div", { style: { display: displayLoad } }, __chunk_1.h("strong", null, " Loading ... "), __chunk_1.h("div", { class: "spinner-grow text-info", role: "status" }, __chunk_1.h("span", { class: "sr-only" }, "Loading...")))
            ]);
        }
        else {
            return ([
                __chunk_1.h("head", null, __chunk_1.h("link", { rel: "stylesheet", href: "https://fonts.googleapis.com/icon?family=Material+Icons" })),
                /* ************************************************************* */
                /* ************* Main component with menu and card ************* */
                /* ************************************************************* */
                /* ************* Menu ************* */
                __chunk_1.h("div", { class: "main-genome-card", style: { display: displayGenomeCard } }, __chunk_1.h("ul", { class: "nav nav-tabs", id: "myTab", role: "tablist" }, tabOrgName.map(name => {
                    let classTag = "nav-link", bool = "false";
                    if (name == this.orgSelected) {
                        classTag = "nav-link active";
                        bool = "true";
                    }
                    return __chunk_1.h("li", { class: "nav-item" }, " ", __chunk_1.h("a", { class: classTag, "data-toggle": "tab", role: "tab", "aria-selected": bool, href: "#", onClick: this.emitOrgChange }, " ", name, " "), " ");
                })), __chunk_1.h("div", { class: "tab-content genomeGraph", id: "myTabContent" }, __chunk_1.h("div", { class: "test", style: { float: "left" } }, __chunk_1.h("div", { class: "select-menu" }, __chunk_1.h("span", null, "References"), __chunk_1.h("select", { class: "custom-select", onChange: e => this.emitRefChange(e) }, this.genomeRef.map(ref => __chunk_1.h("option", null, ref)))), __chunk_1.h("div", { class: "select-menu" }, __chunk_1.h("span", null, "sgRNA"), __chunk_1.h("select", { class: "custom-select", onChange: e => this.emitSgrnaChange(e), style: { background: (this.subSgrna == undefined) ? "none" : "rgba(78, 195, 236, 0.2)" } }, __chunk_1.h("option", null, "  "), (this.subSgrna == undefined) ?
                    (this.allSgrna.map(sgRna => (sgRna != this.sgrnaSelected) ? __chunk_1.h("option", null, sgRna) : __chunk_1.h("option", { selected: true }, sgRna))) :
                    (this.subSgrna.map(sgRna => (sgRna != this.sgrnaSelected) ? __chunk_1.h("option", null, sgRna) : __chunk_1.h("option", { selected: true }, sgRna)))))), __chunk_1.h("div", null, __chunk_1.h("p", { style: { padding: "12px 0px 0px 225px", margin: "Opx 0px 5px 0px" } }, " ", __chunk_1.h("strong", null, " Coordinates Box ")), __chunk_1.h("p", { class: "coordBox" }, this.showCoord())), __chunk_1.h("div", { class: "help" }, __chunk_1.h("i", { class: "material-icons" }, "help"), __chunk_1.h("div", { class: "help-text help-gen" }, " Click on me to reinitialize sgRNA "), __chunk_1.h("div", { class: "help-text help-section" }, " Click on me to display only sgRNA which are on me ")), __chunk_1.h("svg", { id: 'displayGenomicCard', width: this.diagonal_svg, height: this.diagonal_svg }, this.generateGenomicCard(), __chunk_1.h("text", { transform: `translate(${this.diagonal_svg / 2 - 30} , ${this.diagonal_svg / 2})` }, " ", this.sizeSelected, " pb ")), this.generatePlot())),
                // @ts-ignore
                __chunk_1.h("link", { rel: "stylesheet", href: "https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css", integrity: "sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T", crossorigin: "anonymous" }),
                __chunk_1.h("script", { src: "https://code.jquery.com/jquery-3.3.1.slim.min.js", integrity: "sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo", crossorigin: "anonymous" }),
                __chunk_1.h("script", { src: "https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js", integrity: "sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1", crossorigin: "anonymous" }),
            ]);
        }
    }
    get element() { return __chunk_1.getElement(this); }
    static get style() { return ".select-menu{width:200px;margin-top:15px;margin-bottom:15px;margin-left:5px}.select-menu span{margin-left:10px;font-weight:700}.tooltip-coord{position:absolute;text-align:left;width:220px;height:65px;padding:2px;font:12px sans-serif;background:#b0c4de;border:0;border-radius:8px;pointer-events:none}.spinner-grow{width:40!important;height:40!important}.axisCircles{fill:none;stroke:#e8e8e8;stroke-width:1px}.genomeCircle>path:hover,.sunburst>path:hover{cursor:pointer}.coordBox{margin-bottom:17px;margin-left:225px;padding-left:5px;height:105px;width:35%;overflow:scroll;white-space:pre-line;line-height:1.3em;border-style:inset;border-width:thin;border-radius:8px}.tooltip-coord>.material-icons{font-size:12px}.help:hover .help-text{display:block;position:absolute;background:rgba(103,203,222,.9);border-radius:8px;padding:8px}.help{width:24px}.help-text{display:none}.nav-tabs .nav-link.active{color:#4f5d75!important}.nav-link{color:#ef476f!important}.nav-link:hover{background:rgba(187,136,137,.3)!important;color:#4f5d75!important}.nav-tabs .nav-link.active:hover{background:none!important}.svg{position:relative}"; }
}
...
exports.genomic_card = MyComponent;
