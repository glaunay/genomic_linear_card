...
const __chunk_1 = require('./chunk-1d102f17.js');
...
class MyComponent {
    ...
    displayHist() {
        ...
        var svg = select(this.element.shadowRoot.querySelector("#divHist")).append("svg")
            ...
            .append("g");
        let div = select(this.element.shadowRoot.querySelector("#divHist"))
            .append('div')
        ...
        svg.selectAll(".bar")
            ...
            .on("click", e => {
            select(this.element.shadowRoot.querySelector("#sgrnaBox")).html("<strong> Interval : </strong>" +
    ...
    render() {
        ...
        return ([
            __chunk_1.h("div", { id: "pagination", style: { display: displayPagnigation } }, __chunk_1.h("a", { href: "#", class: "previous round", onClick: () => {
                    if (this.page > 1) {
                        this.page -= 1;
                        this.coordGene = this.allCoordGene[this.page - 1];
                        this.dataHist = this.setDataHist();
                    }
                } }, "\u2039"), __chunk_1.h("a", { href: "#", class: "next round", onClick: () => {
                    if (this.page < this.allCoordGene.length) {
                        this.page += 1;
                        this.coordGene = this.allCoordGene[this.page - 1];
                        this.dataHist = this.setDataHist();
                    }
                } }, "\u203A"), __chunk_1.h("div", { class: "alert alert-primary alert-dismissible fade show", id: "alert-show", role: "alert" }, __chunk_1.h("strong", null, "Holy guacamole!"), " You have ", this.allCoordGene.length, " homologous gene in this section.", __chunk_1.h("button", { type: "button", class: "close", "data-dismiss": "alert", "aria-label": "Close" }, __chunk_1.h("span", { "aria-hidden": "true", onClick: () => this.element.shadowRoot.querySelector("#alert-show").id = "alert-hidden" }, "\u00D7")))),
            __chunk_1.h("div", null, __chunk_1.h("div", { id: "binSize" }, "Bin size : ", __chunk_1.h("span", { style: { color: "rgb(239, 71, 111)", width: "35%" } }, Math.ceil((this.coordGene["end"] - this.coordGene["start"]) / this.nb_step))), __chunk_1.h("div", { style: { float: "right", width: "35%" } }, __chunk_1.h("strong", null, " Sgrna box "), __chunk_1.h("div", { id: "sgrnaBox" }))),
            __chunk_1.h("div", { id: "divHist" }, this.displayHist()),
            __chunk_1.h("div", null, __chunk_1.h("div", { class: "geneBar", style: { width: this.width_bar, marginLeft: leftBorderGene } }), __chunk_1.h("span", { style: { marginLeft: leftBorder } }, " ", this.coordGene["start"], " "), __chunk_1.h("span", { style: { marginLeft: rightBorder } }, " ", this.coordGene["end"], " ")),
            // @ts-ignore
